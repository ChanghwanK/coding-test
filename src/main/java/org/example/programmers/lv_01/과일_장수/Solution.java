...
public class Solution {
    ...
    public int solution(int k, int m, int[] score) {
        ...
        // 가능한 상자 수 만큼 사과를 담음
        // 담을 때 최대한 최대 점수로만 담기 (그래야 가격이 높아짐) 이유는 최소점수 * m이기 때문

        // 지금 문제인 점
        // 박스에 사과를 최대 점수만 담는 것이 어려움
        // 좀 더 디테일하게 생각해보면
        // - 어떻게 박스의 최고점과 그 다음 점수 그 다음 점수를 판별할 것인지?
        // - 박스에 어떻게 담을 것인지?
        // - 반복문으로 박스에 값을 담으려고 하다보니 어려움

        // 지금 내가 알 수 있는 것은
        // 최대 점수, 몇박스가 가능한지, score에 최대 점수는 몇개?

        // 박스를 만들 수 있는 만큼 박스를 만듬
